...
export type WorkbenchUiLanguage = "en" | "ko";
export type AgentResponseLanguagePreference = "system" | "en" | "ko" | (string & {});
...
export interface WorkbenchSelectionSnapshot {
  ...
  readonly agentResponseLanguage?: AgentResponseLanguagePreference;
