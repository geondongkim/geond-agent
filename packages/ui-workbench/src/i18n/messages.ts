...
export const uiMessages: Readonly<Record<SupportedUiLanguage, UiMessageCatalog>> = {
  en: {
    ...
    "workbench.runner.cancelled": "Cancel requested for the live runner.",
    "workbench.runner.cancelFailed": "No live runner process was available to cancel.",
  ...
  ko: {
    ...
    "workbench.runner.cancelled": "Live runner 실행 취소를 요청했습니다.",
    "workbench.runner.cancelFailed": "취소할 수 있는 live runner 프로세스가 없습니다.",
