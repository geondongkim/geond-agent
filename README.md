...
- [Desktop workbench stack ADR](docs/adr/0003-desktop-workbench-stack.md)
- [geond-agent-protocol integration strategy](docs/plans/geond-agent-protocol-integration-strategy.md)
